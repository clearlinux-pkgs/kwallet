...
Source0  : https://download.kde.org/stable/frameworks/5.76/kwallet-5.76.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.76/kwallet-5.76.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-5.76.0
cd %{_builddir}/kwallet-5.76.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605419510
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwallet-5.76.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kwallet/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kwallet-5.76.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kwallet/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kwallet-5.76.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwallet/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kwallet-5.76.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kwallet/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kwallet-5.76.0/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwallet/757b86330df80f81143d5916b3e92b4bcb1b1890
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Wallet.so.5.76.0
/usr/lib64/libkwalletbackend5.so.5
/usr/lib64/libkwalletbackend5.so.5.76.0
