...
Source0  : https://download.kde.org/stable/frameworks/5.68/kwallet-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/kwallet-5.68.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-5.68.0
cd %{_builddir}/kwallet-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584315702
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwallet-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwallet/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/kwallet-5.68.0/src/runtime/kwallet-query/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwallet/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Wallet.so.5.68.0
/usr/lib64/libkwalletbackend5.so.5
/usr/lib64/libkwalletbackend5.so.5.68.0
