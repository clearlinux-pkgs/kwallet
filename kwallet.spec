...
Version  : 5.108.0
Release  : 65
URL      : https://download.kde.org/stable/frameworks/5.108/kwallet-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/kwallet-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/kwallet-5.108.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-5.108.0
cd %{_builddir}/kwallet-5.108.0
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Wallet.so.5.108.0
/V3/usr/lib64/libkwalletbackend5.so.5.108.0
/usr/lib64/libKF5Wallet.so.5
/usr/lib64/libKF5Wallet.so.5.108.0
/usr/lib64/libkwalletbackend5.so.5
/usr/lib64/libkwalletbackend5.so.5.108.0
