...
Source0  : https://download.kde.org/stable/frameworks/5.62/kwallet-5.62.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.62/kwallet-5.62.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568917474
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Wallet.so.5.62.0
/usr/lib64/libkwalletbackend5.so.5
/usr/lib64/libkwalletbackend5.so.5.62.0
