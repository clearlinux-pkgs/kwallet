...
Version  : 5.105.0
Release  : 61
URL      : https://download.kde.org/stable/frameworks/5.105/kwallet-5.105.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.105/kwallet-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kwallet-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-5.105.0
cd %{_builddir}/kwallet-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681745042
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Wallet.so.5.105.0
/usr/lib64/libkwalletbackend5.so.5
/usr/lib64/libkwalletbackend5.so.5.105.0
