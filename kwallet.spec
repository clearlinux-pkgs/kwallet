...
Source0  : https://download.kde.org/stable/frameworks/5.104/kwallet-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/kwallet-5.104.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-5.104.0
cd %{_builddir}/kwallet-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679584348
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Wallet.so.5.104.0
/usr/lib64/libkwalletbackend5.so.5
/usr/lib64/libkwalletbackend5.so.5.104.0
