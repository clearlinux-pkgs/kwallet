...
Version  : 6.14.1
Release  : 139
URL      : https://download.kde.org/stable/frameworks/6.14/kwallet-6.14.1.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/kwallet-6.14.1.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kwallet-6.14.1.tar.xz.sig
...
%setup -q -n kwallet-6.14.1
cd %{_builddir}/kwallet-6.14.1
pushd ..
cp -a kwallet-6.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747405739
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Wallet.so.6.14.1
/V3/usr/lib64/libKF6WalletBackend.so.6.14.1
/usr/lib64/libKF6Wallet.so.6
/usr/lib64/libKF6Wallet.so.6.14.1
/usr/lib64/libKF6WalletBackend.so.6
/usr/lib64/libKF6WalletBackend.so.6.14.1
