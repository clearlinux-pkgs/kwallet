...
Version  : 6.6.0
Release  : 96
URL      : https://download.kde.org/stable/frameworks/6.6/kwallet-6.6.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.6/kwallet-6.6.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.6/kwallet-6.6.0.tar.xz.sig
...
%setup -q -n kwallet-6.6.0
cd %{_builddir}/kwallet-6.6.0
pushd ..
cp -a kwallet-6.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726456011
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Wallet.so.6.6.0
/V3/usr/lib64/libKF6WalletBackend.so.6.6.0
/usr/lib64/libKF6Wallet.so.6
/usr/lib64/libKF6Wallet.so.6.6.0
/usr/lib64/libKF6WalletBackend.so.6
/usr/lib64/libKF6WalletBackend.so.6.6.0
